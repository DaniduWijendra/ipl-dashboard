...
public class BatchConfig {
    ...
    public FlatFileItemReader<MatchInput> reader() {
        //read data from csv file and convert data to store in object
    ...
    //process Data using MatchDataProcessor
    @Bean
    public MatchDataProcessor processor() {
        return new MatchDataProcessor();
    }

    //map data to output match object
    //use jpa and insert data into database using Match Object
    @Bean
